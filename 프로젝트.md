...
### 사용자 정의 Exception을 적용하셨는데, 사용자 정의 Exception이 꼭 필요했을까요? 
### 사용자 정의 Exception의 장점과 단점은 무엇인가요?
...
### Oauth2를 적용하셨는데, CustomOAuth2UserService 클래스는 왜 적용하셨고, 
### loadUser 메소드에서 어떤 일이 일어나는지 설명해주세요.
